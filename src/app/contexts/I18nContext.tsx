...
const DICT: Record<string, string[]> = {
  ...
  "profile.doc.overview": ["Overview", "概览", "概覽", "Resumen", "Aperçu", "Überblick", "概要", "개요", "Обзор", "Visão geral", "Panoramica", "نظرة عامة", "सारांश"],
  "profile.doc.expandAll": ["Expand All", "全部展开", "全部展開", "Expandir todo", "Tout développer", "Alle ausklappen", "すべて展開", "모두 펼치기", "Развернуть все", "Expandir tudo", "Espandi tutto", "توسيع الكل", "सभी खोलें"],
  "profile.doc.collapseAll": ["Collapse All", "全部收起", "全部收起", "Contraer todo", "Tout réduire", "Alle einklappen", "すべて折りたたむ", "모두 접기", "Свернуть все", "Recolher tudo", "Comprimi tutto", "طي الكل", "सभी समेटें"],
  "profile.doc.quote": ["Quote", "引用", "引用", "Cita", "Citation", "Zitat", "引用", "인용", "Цитата", "Citação", "Citazione", "اقتباس", "उद्धरण"],
  "profile.doc.copy": ["Copy", "复制", "複製", "Copiar", "Copier", "Kopieren", "コピー", "복사", "Копировать", "Copiar", "Copia", "نسخ", "कॉपी"],
  "profile.doc.copied": ["Copied", "已复制", "已複製", "Copiado", "Copié", "Kopiert", "コピー済み", "복사됨", "Скопировано", "Copiado", "Copiato", "تم النسخ", "कॉपी完成"],
  "profile.doc.copiedToClipboard": ["Copied to clipboard", "已复制到剪贴板", "已複製到剪貼簿", "Copiado al portapapeles", "Copié dans le presse-papiers", "In Zwischenablage kopiert", "クリップボードにコピーしました", "클립보드에 복사됨", "Скопировано в буфер обмена", "Copiado para a área de transferência", "Copiato negli appunti", "تم النسخ إلى الحافظة", "क्लिपबोर्ड में कॉपी किया गया"],
  "profile.doc.searchPlaceholder": ["Search in document", "搜索文档内容", "搜尋文件內容", "Buscar en el documento", "Rechercher dans le document", "Im Dokument suchen", "ドキュメント内を検索", "문서에서 검색", "Поиск по документу", "Pesquisar no documento", "Cerca nel documento", "ابحث في المستند", "दस्तावेज़ में खोजें"],
  "profile.doc.clearSearch": ["Clear search", "清除搜索", "清除搜尋", "Borrar búsqueda", "Effacer la recherche", "Suche löschen", "検索をクリア", "검색 지우기", "Очистить поиск", "Limpar busca", "Cancella ricerca", "مسح البحث", "खोज साफ़ करें"],
  "profile.doc.noMatches": ["No matches", "无匹配结果", "無匹配結果", "Sin resultados", "Aucun résultat", "Keine Treffer", "一致なし", "일치 없음", "Совпадений нет", "Sem resultados", "Nessun risultato", "لا توجد نتائج", "कोई मिलान नहीं"],
  "profile.doc.previousMatch": ["Previous match", "上一个匹配", "上一個匹配", "Resultado anterior", "Résultat précédent", "Vorheriger Treffer", "前の一致", "이전 일치", "Предыдущее совпадение", "Resultado anterior", "Corrispondenza precedente", "المطابقة السابقة", "पिछला मिलान"],
  "profile.doc.nextMatch": ["Next match", "下一个匹配", "下一個匹配", "Siguiente resultado", "Résultat suivant", "Nächster Treffer", "次の一致", "다음 일치", "Следующее совпадение", "Próximo resultado", "Corrispondenza successiva", "المطابقة التالية", "अगला मिलान"],
  "profile.doc.source": ["Source", "源文件", "來源檔案", "Origen", "Source", "Quelle", "ソース", "원본", "Источник", "Origem", "Sorgente", "المصدر", "स्रोत"],
  "profile.doc.copyRaw": ["Copy raw", "复制原文", "複製原文", "Copiar original", "Copier le brut", "Rohtext kopieren", "原文をコピー", "원문 복사", "Копировать исходник", "Copiar bruto", "Copia testo grezzo", "نسخ النص الأصلي", "मूल पाठ कॉपी करें"],
  "profile.doc.export": ["Export", "导出", "匯出", "Exportar", "Exporter", "Exportieren", "エクスポート", "내보내기", "Экспорт", "Exportar", "Esporta", "تصدير", "निर्यात करें"],
  "profile.doc.exporting": ["Exporting", "导出中", "匯出中", "Exportando", "Exportation en cours", "Export läuft", "書き出し中", "내보내는 중", "Экспортируется", "Exportando", "Esportazione in corso", "جارٍ التصدير", "निर्यात हो रहा है"],
  "profile.doc.exported": ["Exported", "已导出", "已匯出", "Exportado", "Exporté", "Exportiert", "書き出し完成", "내보내기 완료", "Экспортировано", "Exportado", "Esportato", "تم التصدير", "निर्यात किया गया"],
  "profile.doc.exportFailed": ["Export failed", "导出失败", "匯出失敗", "Error al exportar", "Échec de l'export", "Export fehlgeschlagen", "書き出し失敗", "내보내기 실패", "Ошибка экспорта", "Falha ao exportar", "Esportazione non riuscita", "فشل التصدير", "निर्यात विफल"],
  "profile.doc.fileName": ["File", "文件名", "檔名", "Archivo", "Fichier", "Datei", "ファイル", "파일", "Файл", "Arquivo", "File", "الملف", "फ़ाइल"],
  "profile.doc.sourcePath": ["Path", "路径", "路徑", "Ruta", "Chemin", "Pfad", "パス", "경로", "Путь", "Caminho", "Percorso", "المسار", "पथ"],
  "profile.doc.workspace": ["Workspace", "工作区", "工作區", "Workspace", "Espace de travail", "Workspace", "ワークスペース", "워크스페이스", "Рабочее пространство", "Workspace", "Workspace", "مساحة العمل", "वर्कस्पेस"],
  "profile.doc.copyPath": ["Copy path", "复制路径", "複製路徑", "Copiar ruta", "Copier le chemin", "Pfad kopieren", "パスをコピー", "경로 복사", "Копировать путь", "Copiar caminho", "Copia percorso", "نسخ المسار", "पथ कॉपी करें"],
  "profile.doc.sourceUnavailable": ["Original source metadata is unavailable. You can still copy or export the current content.", "当前没有可用的原始源文件元数据，但仍可复制或导出当前内容。", "目前沒有可用的原始來源檔案中繼資料，但仍可複製或匯出目前內容。", "Los metadatos del origen no están disponibles. Aun así puedes copiar o exportar el contenido actual.", "Les métadonnées de la source d'origine ne sont pas disponibles. Vous pouvez quand même copier ou exporter le contenu actuel.", "Die Metadaten der Originalquelle sind nicht verfügbar. Der aktuelle Inhalt kann trotzdem kopiert oder exportiert werden.", "元のソースメタデータは利用できませんが、現在の内容はコピーまたは書き出しできます。", "원본 소스 메타데이터를 사용할 수 없지만 현재 내용은 복사하거나 내보낼 수 있습니다.", "Метаданные исходного файла недоступны, но текущее содержимое все равно можно копировать или экспортировать.", "Os metadados da fonte original não estão disponíveis, mas você ainda pode copiar ou exportar o conteúdo atual.", "I metadati della sorgente originale non sono disponibili, ma puoi comunque copiare o esportare il contenuto attuale.", "بيانات المصدر الأصلية غير متاحة حالياً، لكن لا يزال بإمكانك نسخ المحتوى الحالي أو تصديره.", "मूल स्रोत मेटाडेटा उपलब्ध नहीं है, लेकिन आप वर्तमान सामग्री को फिर भी कॉपी या निर्यात कर सकते हैं।"],
  ...
  "profile.saveFailed": ["Failed to save {0}", "保存 {0} 失败", "保存 {0} 失敗"],
  "profile.readOnlyNotice": ["Current connection is read-only. Identity / Soul editing requires operator.admin.", "当前连接是只读模式。编辑 Identity / Soul 需要 operator.admin 权限。", "目前連線是唯讀模式。編輯 Identity / Soul 需要 operator.admin 權限。"],
  "profile.readOnlyScopes": ["Granted scopes: {0}. Reconnect with admin scope or use Token / Password auth with admin privileges.", "当前已授予 scopes: {0}。请重新连接并申请 admin scope，或改用具备管理员权限的 Token / Password 认证。", "目前已授予 scopes: {0}。請重新連線並申請 admin scope，或改用具備管理員權限的 Token / Password 認證。"],
