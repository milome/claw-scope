  ...
  return (
    <div className="rounded-[24px] border border-slate-200/90 bg-white shadow-sm transition-colors dark:border-slate-700 dark:bg-slate-950/50">
      <textarea
        ...
        onChange={(event) => onChange(event.target.value)}
        spellCheck={false}
        className="min-h-[360px] w-full resize-y rounded-[24px] bg-transparent px-4 py-4 font-mono text-[13px] leading-6 text-slate-800 outline-none placeholder:text-slate-400 md:min-h-[420px] dark:text-slate-100 dark:placeholder:text-slate-500"
      />
    </div>
  );
}
      ...
      <div className="flex flex-col md:flex-row flex-1 gap-4 md:gap-6 min-h-0">
        ...
        <div className="flex-1 flex flex-col min-h-0 overflow-y-auto md:pr-2 rtl:md:pr-0 rtl:md:pl-2 hide-scrollbar">
          <AnimatePresence mode="wait">
            ...
            >
              {/* Card Body */}
              <div className="relative flex shrink-0 w-full flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_22px_52px_rgba(15,23,42,0.08)] transition-colors before:pointer-events-none before:absolute before:inset-x-8 before:top-0 before:h-0.5 before:rounded-full before:bg-gradient-to-r before:from-sky-400 before:via-cyan-400 before:to-violet-400 dark:border-slate-800 dark:bg-slate-900 dark:before:from-sky-300 dark:before:via-cyan-300 dark:before:to-violet-300 md:rounded-3xl">
                <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(148,163,184,0.05)_1px,transparent_1px),linear-gradient(to_bottom,rgba(148,163,184,0.05)_1px,transparent_1px)] bg-[size:24px_24px] dark:bg-[linear-gradient(to_right,#ffffff0a_1px,transparent_1px),linear-gradient(to_bottom,#ffffff0a_1px,transparent_1px)]" />
                <div className="relative z-10 space-y-4 p-4 md:space-y-5 md:p-6 xl:p-8">
                  <div className="space-y-4">
                    <div className="relative overflow-hidden rounded-[30px] border border-slate-200/90 bg-[linear-gradient(135deg,rgba(255,255,255,0.98),rgba(241,250,255,0.96),rgba(244,244,255,0.94))] p-4 shadow-[0_18px_42px_rgba(15,23,42,0.08)] dark:border-slate-800/80 dark:bg-[linear-gradient(135deg,rgba(15,23,42,0.96),rgba(15,23,42,0.86),rgba(30,41,59,0.8))] md:p-5">
                      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(14,165,233,0.16),transparent_42%),radial-gradient(circle_at_bottom_left,rgba(168,85,247,0.12),transparent_35%)]" />
                      <div className="relative z-10 flex min-w-0 items-center gap-4">
                        <AgentAvatar
                          agent={activeAgent}
                          containerClassName="h-20 w-20 shrink-0 rounded-[28px] shadow-[0_18px_36px_rgba(15,23,42,0.12)] md:h-24 md:w-24"
                          iconClassName="h-9 w-9 text-white md:h-11 md:w-11"
                          emojiClassName="text-4xl md:text-5xl"
                        />
                        <div className="min-w-0 space-y-3">
                          <div className="space-y-1">
                            <h2 className="truncate text-2xl font-bold tracking-tight text-slate-900 dark:text-white md:text-[2rem]">
                              {activeAgent.name}
                            </h2>
                            <div className="flex flex-wrap items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400">
                              <span className="inline-flex items-center gap-1.5 rounded-full border border-sky-200/80 bg-sky-50/90 px-2.5 py-1 text-sky-700 dark:border-sky-500/30 dark:bg-sky-500/10 dark:text-sky-200">
                                <Network className="h-3.5 w-3.5" />
                                {activeAgent.node}
                              </span>
                              <span className="inline-flex items-center gap-1.5 rounded-full border border-slate-200/80 bg-white/90 px-2.5 py-1 text-slate-600 dark:border-slate-700 dark:bg-slate-900/70 dark:text-slate-300">
                                <Hash className="h-3.5 w-3.5 text-sky-500 dark:text-sky-300" />
                                {activeAgent.id}
                              </span>
                            </div>
                          </div>
                          <div className="flex flex-wrap gap-2">
                            <div className="inline-flex items-center gap-2 rounded-full border border-slate-200/90 bg-white/90 px-3 py-1.5 text-xs font-medium text-slate-700 shadow-sm dark:border-slate-700 dark:bg-slate-950/70 dark:text-slate-200">
                              <Activity
                                className={`h-4 w-4 ${resolveStatusTextClass(activeAgent.statusKey)}`}
                              />
                    ...
                    <div className="relative overflow-hidden rounded-[28px] border border-slate-200/90 bg-white/90 p-4 shadow-[0_16px_36px_rgba(15,23,42,0.06)] dark:border-slate-800 dark:bg-slate-950/70 md:p-5">
                      <div className="mb-3 flex items-center justify-between gap-3">
                        <div>
                          <div className="text-[11px] font-semibold uppercase tracking-[0.22em] text-slate-400 dark:text-slate-500">
                            ...
                            {isIdentityMetaDirty ? (
                              <span className="ml-2 rounded-full bg-sky-100 px-2 py-0.5 text-[10px] font-semibold tracking-[0.12em] text-sky-700 dark:bg-sky-500/15 dark:text-sky-200">
                                {t("profile.unsaved")}
                              </span>
                            ) : null}
                          </div>
                        ...
                        <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-slate-50 px-3 py-1.5 text-xs font-semibold text-slate-600 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300">
                          <IdCard className="h-3.5 w-3.5 text-sky-500 dark:text-sky-300" />
                          {t("profile.identityFields")}
                        </div>
                      </div>
                      {hasRealAgents ? (
                  ...
                  {hasRealAgents && !hasAdminScope ? (
                    <div className="rounded-2xl border border-amber-200 bg-amber-50/90 px-4 py-4 shadow-sm transition-colors dark:border-amber-900/50 dark:bg-amber-950/30">
                      <div className="flex items-start gap-3">
                  ...
                  {activeAgentError ? (
                    <div className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800 transition-colors dark:border-amber-900/60 dark:bg-amber-950/30 dark:text-amber-300">
                      {activeAgentError}
                    </div>
                  ) : null}

                  <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-slate-200/70 bg-white/72 px-3 py-2.5 shadow-sm dark:border-slate-800 dark:bg-slate-950/45">
                    <div className="flex flex-wrap gap-2 text-xs font-medium text-slate-600 dark:text-slate-300">
                      <span className="inline-flex items-center gap-1.5 rounded-full bg-sky-50 px-2.5 py-1 text-sky-700 dark:bg-sky-500/10 dark:text-sky-200">
                      ...
                      <span className="inline-flex items-center gap-1.5 rounded-full bg-violet-50 px-2.5 py-1 text-violet-700 dark:bg-violet-500/10 dark:text-violet-200">
                      ...
                      <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-50 px-2.5 py-1 text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-200">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <button
                        ...
                        className="inline-flex items-center justify-center gap-2 rounded-xl bg-slate-900 px-3.5 py-2 text-xs font-semibold text-white shadow-sm transition-all hover:bg-black dark:bg-violet-600 dark:hover:bg-violet-500 md:group"
                      >
                        <Database className="h-3.5 w-3.5 text-violet-400 dark:text-violet-200" />
                        {t("profile.btn.memory")}
                        <ArrowRight className="h-3.5 w-3.5 text-slate-500 transition-transform dark:text-violet-200 md:group-hover:translate-x-1 rtl:rotate-180 rtl:md:group-hover:-translate-x-1" />
                      </button>
                      <button
                        onClick={() => navigate("/config")}
                        className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-3.5 py-2 text-xs font-semibold text-slate-700 shadow-sm transition-all hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:hover:bg-slate-800"
                      >
                  ...
                  <div className="space-y-4 rounded-[30px] border border-slate-200/80 bg-[linear-gradient(180deg,rgba(248,250,252,0.88),rgba(255,255,255,0.96))] p-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.88)] dark:border-slate-800/80 dark:bg-[linear-gradient(180deg,rgba(15,23,42,0.34),rgba(2,6,23,0.26))] md:p-4">
                    ...
                    <div className="grid gap-4 xl:grid-cols-2">
                      <ProfileSectionCard tone="sky" className="h-full">
                        ...
                        <div className="transition-colors">
                          {isEditingIdentityDoc ? (
                            ...
                            <AgentDocument
                              ...
                              content={
                                activeAgent.identity || t("profile.noIdentity")
                              }
                              tone="identity"
                        ...
                        <div className="mt-4 flex flex-wrap gap-2">
                          {activeAgent.tags?.map((tag) => (
                            <span
                              key={tag}
                              className="rounded-lg border border-slate-200 bg-slate-100 px-2.5 py-1 text-xs font-medium text-slate-600 transition-colors dark:border-slate-700/50 dark:bg-slate-800/80 dark:text-slate-300"
                            >
                              {tag}
                            </span>
                          ))}
                      ...
                      <ProfileSectionCard tone="violet" className="h-full">
                        <div className="mb-4 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                          <ProfileSectionHeader
                            icon={Sparkles}
                          ...
                          <ProfileSectionActions
                            ...
                            reloadDisabled={
                              !canEditActiveAgent || isSavingSoulDoc
                            }
                            editDisabled={!canEditActiveAgent}
