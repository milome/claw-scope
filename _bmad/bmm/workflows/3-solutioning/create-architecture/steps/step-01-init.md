...
- Look for existing {planning_artifacts}/{branch}/`*architecture*.md`
...
Copy the template from `{installed_path}/architecture-decision-template.md` to `{planning_artifacts}/{branch}/architecture.md`
...
- Created: `{planning_artifacts}/{branch}/architecture.md` from template
