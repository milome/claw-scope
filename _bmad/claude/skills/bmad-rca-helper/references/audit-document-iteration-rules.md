...
本文件与项目内 `.claude/skills/speckit-workflow/references/audit-document-iteration-rules.md` 精神一致，适用于对 **RCA 助手产出的任务列表/TASKS 风格文档** 的审计迭代。
...
完整版规则与适用范围见：`{project-root}/.claude/skills/speckit-workflow/references/audit-document-iteration-rules.md`。
