...
RUN_DIR = ROOT / "tmp" / "imagegen" / "clawscope-cover-api-run"
PROMPT_PATH = ROOT / "tmp" / "imagegen" / "clawscope-cover-bg-prompt.txt"
ICON_PATH = ROOT / "icon-source.png"
OUT_PATH = ROOT / "public" / "images" / "covers" / "clawscope-cover-bg.png"
...
def read_api_key():
    ...
    if value:
        return value
    if os.name == "nt":
        # Environment variables with hyphens are often configured at User scope
        # but not inherited by already-running shells.
        import subprocess
