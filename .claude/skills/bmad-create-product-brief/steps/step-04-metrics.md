...
Before you offer `[C] Continue`, validate that the current metrics section explicitly covers:
...
- IF P: Invoke the `bmad-party-mode` skill with the `brief-gate` stage profile and current blocker/gap context to bring different perspectives to validate comprehensive metrics and repair blocker gaps
