...
var governance_execution_result_ingestor_exports = {};
__export(governance_execution_result_ingestor_exports, {
  ingestGovernanceExecutionResult: () => ingestGovernanceExecutionResult,
  ingestGovernanceRerunGateResult: () => ingestGovernanceRerunGateResult
});
module.exports = __toCommonJS(governance_execution_result_ingestor_exports);
    ...
    (record) => {
      ...
      return {
        ...
        rerunGateSchedule: isSuccess ? {
          ...
          scheduledAt: config.execution?.rerunGate.autoSchedule ? nowIso2() : null,
          observedAt: null,
    ...
    (record) => {
      ...
      return {
        ...
        rerunGateSchedule: {
          ...
          observedAt: input.rerunGateResult.observedAt ?? nowIso2(),
          note: input.rerunGateResult.summary ?? null
        },
        history: [
          ...record.history,
          {
            at: input.rerunGateResult.observedAt ?? nowIso2(),
